...
<!-- Main modal -->
<div id="default-modal-{{ $identificador }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-z-9999 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
